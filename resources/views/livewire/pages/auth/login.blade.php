...
<div>
    ...
    <form wire:submit="login">
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('auth.login_email')" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('auth.login_password')" />
        ...
        <div class="block mt-4">
            <label for="remember" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">{{ __('auth.login_remember_me') }}</span>
            </label>
        </div>
