...
export function AdminDashboardPage({ onSelectTab, onNavigate, tournamentsCount, registrationsCount }) {
  ...
  const cards = [
    ...
    {
      key: 'clubs',
      title: t('Vereine & Bouleplätze'),
      description: t('Vereine, Bouleplätze und Meldungen freigeben'),
      statLabel: t('Offene Vorgänge'),
      statValue: stats ? stats.pendingClubEditorRequests + stats.pendingPlaces + stats.pendingPlaceReports : undefined,
